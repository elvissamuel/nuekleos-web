...
import { createPost, getCategories } from "@/lib/api-calls";
...
const NewBlogPostForm = ({ onSuccess }: NewBlogPostFormProps) => {
                    ...
                    <SelectContent>
                      {categories && categories.length > 0 ? (
                        ...
                        <SelectItem value="no-categories" disabled>
                          No categories available. Create one in Categories page.
                        </SelectItem>
                      )}
                    </SelectContent>
                  </Select>
